...
class TestRemove(unittest.TestCase):
    ...
    logger = log.Logger('debug', 'debug', 'test.log', False)
    def setUp(self):
    ...
    def test_run_remove_empty_dir(self):
        handler_empty_dir = HandlerRemove(True, False, False, 'basket', self.logger)
    ...
    def test_run_remove_dir(self):
        handler_dir = HandlerRemove(False, True, False, 'basket', self.logger)
        handler_dir.run(self.dir_path)
        self.assertEqual(os.path.exists(self.dir_path), False)
    def test_run_remove_file(self):
        handler_file = HandlerRemove(False, False, False, 'basket', self.logger)
    ...
    def test_run_remove_not_empty_dir_with_msg(self):
        handler_file = HandlerRemove(True, False, False, 'basket', self.logger)
